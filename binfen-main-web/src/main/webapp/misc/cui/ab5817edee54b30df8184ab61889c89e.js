...
!function () {
    ...
    var util = {
        isMobilePlatform: function () {
            ...
            if (xhr) {
                try {
                    if ("GET" === method.toUpperCase()) url = url + "?" + util.mergeParams(data);
                    xhr.open(method, url)
                } catch (ex) {
                    error();
                    return
    ...
    var buildProxy = function () {
        if (!proxy) {
            ...
            util.addEvent(proxy, "load", function (e) {
                inited = !0;
                syncWebAnalytics()
            })
        }
    ...
    ysf.openInline = function (e, t) {
        if (ysf.openInline.load && util.isFunction(t))return t();
            ...
            if (!e) {
                ...
                if (n.style && n.style.type) {
                    ...
                    if (util.isArray(n.style.oprs)) {
                        var s = null, l = null;
                        for (var f = 0; f < n.style.oprs.length; f++) {
                            s = n.style.oprs[f];
                    ...
                    var t = e.childNodes[0], i = t.childNodes, u = i[0];
                    if ("innerText" in u) u.innerText = n.style.welcomeText; else u.textContent = n.style.welcomeText;
                    t.onclick = function () {
                        ysf.open();
                        c()
                    };
    ...
    ysf.config = function (e) {
        if (e) {
            ...
            if (cache.appKey) {
                ...
                if (e.bid) initWinConfigTrade(); else initWinConfig()
            }
        }
    };
    ...
    ysf.product = function () {
        var e = function (e) {
            ...
            return {title: e.title, desc: e.desc, picture: e.picture, url: e.url, note: e.note, show: e.show}
        };
        return function (t) {
            var n = e(t);
    ...
    ysf.on = function () {
        ...
        return function (t) {
            ...
            if (/object/gi.test(n)) {
                for (var i in t)if ("onload" == i && util.isFunction(t[i]))if (!inited) util.addEvent(proxy, e[i], t[i]); else t[i](); else if (util.isFunction(ysf[i]) && util.isFunction(t[i])) ysf["_" + i] = t[i]
    ...
    try {
        if ("http:" == location.protocol || "https:" == location.protocol) {
            ...
            iframe.src = "//ipservice.163.com/if/box";
            iframe.id = "YSF-IFRAME-DATA";
...
var __YSFOPTION__ = {
    ...
    hidden: 1,
    preloadIframe: 1,
    appKey: 'ab5817edee54b30df8184ab61889c89e'
};
__YSFOPTION__.uid = '';
try {
...
window.inviteSetting = {
    ...
    style: {
        ...
        bdImageY: 0,
        type: 0,
        welcomeText: "您好，欢迎光临翠鲜缘.com,请问有什么可以帮助您？",
        bdImageX: 0
    },
    waitTime: 15,
    rejectType: 0,
