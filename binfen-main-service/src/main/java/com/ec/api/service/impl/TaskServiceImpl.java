...
public class TaskServiceImpl implements TaskService{
		...
		while(true){
			...
			for(int i = 0 ; i < list.size() ; i++){
				...
				if(task.getType() == 4){//可自提消息
					this.sendZitiTemplateMessage(task.getContent());
				}
				if(task.getType() == 5){//订单完成消息
					this.sendFinishTemplateMessage(task.getContent());
				}
	...
	private boolean sendDeliverySuccessTemplateMessage(String taskContent){
		try{
			...
			keyword3.put("value", sdf.format(orderInfo.getSendOutTime()));
	 ...
	 * 订单可自提模板消息
	 */
	private boolean sendZitiTemplateMessage(String taskContent){
		try{
			Map<String, Object> taskMap = JsonUtils.readValue(taskContent);
			Integer orderId = (Integer)taskMap.get("orderId");
			Integer uid = (Integer)taskMap.get("uid");
			...
			map.put("template_id", "TNxjIr3dCDhagWqHWq1pFI7ngVroKQFRHbjzKQpZ7X4");

			Map<String, String> first = new HashMap<String, String>();
			first.put("value", "您好，您的订单已经备货完成，请您到实体店自提");
			first.put("color", "#173177");
			...
			Map<String, String> keyword2 = new HashMap<String, String>();
			keyword2.put("value", "两天内。");
			keyword2.put("color", "#173177");

			Map<String, String> remark = new HashMap<String, String>();
			remark.put("value", "自提门店："+orderInfo.getHopeArrivalTime());
			remark.put("color", "#173177");
	 ...
	 * 订单可自提模板消息
	 */
	private boolean sendFinishTemplateMessage(String taskContent){
		try{
			Map<String, Object> taskMap = JsonUtils.readValue(taskContent);
			Integer orderId = (Integer)taskMap.get("orderId");
			Integer uid = (Integer)taskMap.get("uid");
			...
			map.put("template_id", "GV4zwWmv34uQqNLXnTVOOX2r-ZKRUdtAyDB8dqYsJmA");

			Map<String, String> first = new HashMap<String, String>();
			first.put("value", "尊敬的用户您好，您的订单已完成。");
			first.put("color", "#173177");
			...
			Map<String, String> keyword2 = new HashMap<String, String>();
			keyword2.put("value", sdf.format(orderInfo.getFinishTime()));
			keyword2.put("color", "#173177");

			Map<String, String> remark = new HashMap<String, String>();
			remark.put("value", "如有任何疑问，请拨打：0335-3188123");
			remark.put("color", "#173177");
